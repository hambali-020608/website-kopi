export default function Menu({coffe,children,title="Menu"}){
    return(
          ...
          <div  class={`rounded-lg border border-[#EBB25B] ${title=="Menu"?'bg-[#4f2b14]':'bg-black'} p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800`}>
              ...
              <div class="pt-6">
                <div class="mb-4 flex itemsnter justify-between gap-4">
                ...
                <a href="#" class="text-white text-lg font-semibold leading-tight ">{coffe.name}</a>
                ...
                <div class="mt-4 flex items-center justify-between gap-4">
                  <p class="text-2xl font-extrabold leading-tight text-[#EBB25B]">Rp {coffe.price}</p>
                {children}
